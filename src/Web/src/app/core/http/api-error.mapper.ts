...
const knownCodes = new Set([
  'VALIDATION_ERROR', 'PRODUCT_NOT_FOUND', 'PRODUCT_CODE_ALREADY_EXISTS', 'INVOICE_NOT_FOUND',
  'INVOICE_ALREADY_CLOSED', 'INSUFFICIENT_STOCK', 'IDEMPOTENCY_CONFLICT', 'INVENTORY_UNAVAILABLE',
  'RATE_LIMIT_EXCEEDED', 'UNEXPECTED_ERROR',
]);
